...
REF_WORK_DIR_PATH="${HOME}/work/anduinos-iso-builder-remix-advance-gnome-shell"
...
echo "[Next Step]: cd ~/work/anduinos-iso-builder-remix-advance-gnome-shell/iso-profile
"
echo
