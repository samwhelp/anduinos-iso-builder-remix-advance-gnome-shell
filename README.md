...
# anduinos-iso-builder-remix-advance-gnome-shell
...
* [Module / Ignored](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-gnome-shell/blob/main/helper/docs/module/module-ignored.md)
* [Module / Adjusted](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-gnome-shell/blob/main/helper/docs/module/module-adjusted.md)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-gnome-shell/tree/main/asset/template/src/mods/14-my-extra-1020-overlay-mod/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-gnome-shell/tree/main/asset/template/src/mods/14-my-extra-1020-overlay-mod/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-gnome-shell/tree/main/asset/template/src/mods/14-my-extra-1020-overlay-mod/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [anduinos-iso-builder-remix-advance-gnome-shell](https://github.com/samwhelp/anduinos-iso-builder-remix-advance-gnome-shell)

``` sh
git clone https://github.com/samwhelp/anduinos-iso-builder-remix-advance-gnome-shell.git
```


> change dir to `anduinos-iso-builder-remix-advance-gnome-shell`

``` sh
cd anduinos-iso-builder-remix-advance-gnome-shell
```
...
> change dir to `~/work/anduinos-iso-builder-remix-advance-gnome-shell/iso-profile`

``` sh
cd ~/work/anduinos-iso-builder-remix-advance-gnome-shell/iso-profile
```
...
> change dir to `~/work/anduinos-iso-builder-remix-advance-gnome-shell/iso-profile/src`

``` sh
cd ~/work/anduinos-iso-builder-remix-advance-gnome-shell/iso-profile/src
```
